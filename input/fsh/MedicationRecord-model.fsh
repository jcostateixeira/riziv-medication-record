...
* statusReason 0..* CodeableConcept "Why a dispense was not performed" ""
* product[x] 1..1 Reference(Medication) or CodeableConcept "The product that was dispensed - coded or not (e.g. for magistral preparations)" "" //best would be codableReference
...
* product 1..1 Reference(Medication) "Medication to be taken" ""
...
* reason 0..* Reference(Condition or Observation) "Reason or indication for ordering or not ordering the medication" ""
...
* product 1..1 Reference(Medication) "What medication was taken" ""
...
* reason 0..* Reference(Condition or Observation or DiagnosticReport) "Reason for why the medication is being/was taken" ""
...
* product 1..1 Reference(Medication) "What was administered" ""
...
* reason 0..* Reference(Condition or Observation or DiagnosticReport) "Concept, condition or observation that supports why the medication was administered" ""
